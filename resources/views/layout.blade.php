        ...
        <div class="col-lg-12 col-sm-12 col-12">
            <div class="dropdown">
                ...
                <button id="dLabel" type="button" class="btn btn-primary" data-bs-toggle="dropdown">
                    <i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart1 <span class="badge bg-danger">{{ count((array) session('cart')) }}</span>
                </button>
                        ...
                        @foreach(session('cart') as $id => $details)
                            <div class="row cart-detail">
                                <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
                                    <img width="80%" src="{{ asset('images') }}/{{ $details['photo'] }}" />
                                </div>
