...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('https://startbootstrap.github.io/startbootstrap-sb-admin-2/vendor/fontawesome-free/css/all.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('https://startbootstrap.github.io/startbootstrap-sb-admin-2/css/sb-admin-2.min.css') }}">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            @if($errors->has('失敗'))
    <div class="alert alert-danger">{{ $errors->first('失敗') }}</div>
@endif
                     
                    
                                        <h1 class="h4 text-gray-900 mb-4">Welcome Back!</h1>
                                    </div>
                                    <form class="user" action="{{ route('lolo') }}" method="POST">
                                        @csrf
